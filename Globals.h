...
extern void explodeObject(uint8_t* pFlags, WorldPos worldPos, uint8_t type);
extern void fireAtPlayer(PlayerShip* pPlayerShip, WorldPos startPos);
extern void verticalWrap(WorldPos* pos);
