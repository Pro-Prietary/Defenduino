...
// No logo in debug mode to bring the binary size down
#ifdef _DEBUG
const unsigned char logo[] PROGMEM = { 0x0, 0x0,};
#else
...
#else
const char scrollText[] PROGMEM = " ... VERSION 1.1 ... BY ALEX MCCHESNEY ... WASHINGUP.ITCH.IO ... ";
#endif
